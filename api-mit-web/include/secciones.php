 ...
 * Class seccion
 *
 * Class de seccion con los metodos de acceso a la tabla de tbl_secciones
 *
...
class seccion extends  db {
    /**
     * Constructor de la class seccion
    ...
    */
            ...
            switch($this->returnType){
                ...
                case 'xml':
                  ...
                  $xml=$dom->createDocument(null, null, $doctype);
                    $xml->encoding ='UTF-8';
                    $rootTag=$xml->createElement('seccion');
    ...
    /**
     * Obtener secciones , permite pasar parametros de paginacion
    ...
    // Fields Information
        ...
        switch($this->returnType){
            ...
            case 'xml':
              ...
              $xml=$dom->createDocument(null, null, $doctype);
              $xml->encoding ='UTF-8';
                $rootTag=$xml->createElement('secciones');
                for($k=0; $k<count($arrRows);$k++){
                    $itemTag=$xml->createElement('seccion');
