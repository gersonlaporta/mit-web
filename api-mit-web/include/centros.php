 ...
 * Class centro
 *
 * Class de centro con los metodos de acceso a la tabla de tbl_centros
 *
 ...
 */
class centro extends  db {
    /**
     * Constructor de la class centro
    ...
    */
        ...
        $sql="SELECT {$this->tabla}.*
            ...
            switch($this->returnType){
                ...
                case 'xml':
                    ...
                    $xml->encoding ='UTF-8';
                    $rootTag=$xml->createElement('centro');
    ...
    /**
     * Obtener centros , permite pasar parametros de paginacion
    ...
    public function getAll ($start='',$page='' ){
        ...
        switch($this->returnType){
            ...
            case 'xml':
            	...
            	$xml=$dom->createDocument(null, null, $doctype);
            	$xml->encoding ='UTF-8';
                $rootTag=$xml->createElement('centros');
                for($k=0; $k<count($arrRows);$k++){
                    $itemTag=$xml->createElement('centro');
